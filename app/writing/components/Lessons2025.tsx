    ...
    return (
        <div className="space-y-24">
            ...
            <section className="space-y-6">
                <h2 className="text-xl text-black mb-6">Speed is the advantage. Direction is the multiplier.</h2>
            ...
            {/* Shipping */}
            <section className="space-y-6">
                <h2 className="text-xl text-black mb-6">Shipping is the real identity. Half-built doesn’t count.</h2>
                <p className="text-base text-black/70 mb-8 font-sans leading-relaxed border-l-2 border-gray-800 pl-4">
            ...
            {/* Integrity */}
            <section className="space-y-6">
                <h2 className="text-xl text-black mb-6">Integrity is leverage. Shortcuts are expensive.</h2>
                <p className="text-base text-black/70 mb-8 font-sans leading-relaxed border-l-2 border-gray-800 pl-4">
            ...
            {/* Usefulness */}
            <section className="space-y-6">
                <h2 className="text-xl text-black mb-6">Usefulness beats impressiveness. Outcomes beat optics.</h2>
                <p className="text-base text-black/70 mb-8 font-sans leading-relaxed border-l-2 border-gray-800 pl-4">
            ...
            {/* Structure */}
            <section className="space-y-6">
                <h2 className="text-xl text-black mb-6">Structure creates freedom. No structure becomes drift.</h2>
                <p className="text-base text-black/70 mb-8 font-sans leading-relaxed border-l-2 border-gray-800 pl-4">
            ...
            {/* Intensity */}
            <section className="space-y-6">
                <h2 className="text-xl text-black mb-6">Intensity can fake alignment. Fast isn’t automatically right.</h2>
                <p className="text-base text-black/70 mb-8 font-sans leading-relaxed border-l-2 border-gray-800 pl-4">
            ...
            {/* People */}
            <section className="space-y-6">
                <h2 className="text-xl text-black mb-6">People are multipliers or liabilities. Reliability is the filter.</h2>
                <p className="text-base text-black/70 mb-8 font-sans leading-relaxed border-l-2 border-gray-800 pl-4">
            ...
            {/* Ownership */}
            <section className="space-y-6">
                <h2 className="text-xl text-black mb-6">Ownership compounds. Prestige fades.</h2>
                <p className="text-base text-black/70 mb-8 font-sans leading-relaxed border-l-2 border-gray-800 pl-4">
