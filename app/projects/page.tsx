...
const projects = [
    {
        title: "Zero-Sum",
        description: "This is a little thought experiment: agents play a zero-sum game, survive by making money to increase their api budget. ",
        href: ""
    },
    {
        title: "Hackerfab",
    ...
    {
        title: "Talos",
        description: "Hardware accelerator for convolutional neural networks that runs inference fully on chip.",
        href: "http://talos.wtf/"
    },
    {
        title: "Vid2ASCII",
        ...
        <main className="min-h-screen w-full bg-white text-black p-8 flex flex-col items-center">
            <div className="max-w-[500px] w-full">
                ...
                <div className="text-left mb-12">
                    <p className="text-xs italic text-gray-500">materialized thoughts</p>
                </div>
                    ...
                    {projects.map((project, index) => (
                        <div key={index} className="space-y-1">
                            <Link
                                ...
                                className="block text-sm font-medium hover:text-gray-600 underline decoration-1 underline-offset-4 transition-colors"
                            >
                                {project.title}
                            </Link>
